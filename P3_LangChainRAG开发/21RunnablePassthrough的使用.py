...
# langchain中向量存储对象，方法：as_retrieve，可以返回一个Runnable接口的子类实例对象
retrieve = vector_store.as_retriever(search_kwargs={"k": 2})

# chain
chain = (
    {"input": RunnablePassthrough(), "context": retrieve | format_func} | prompt | print_prompt | model | StrOutputParser()
)
